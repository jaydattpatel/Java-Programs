...
class Collection_Set_LinkedHashSet {
     
    public static void main(String args[]){  
      
        Set<Student> LinkedHash_set = new LinkedHashSet<Student>();

        System.out.println("LinkedHash_set.isEmpty(): " + LinkedHash_set.isEmpty());
        ...
        LinkedHash_set.add(st1);        
        LinkedHash_set.add(st2);
        LinkedHash_set.add(st3);        
        LinkedHash_set.add(st4); 
        LinkedHash_set.add(st5); 
        LinkedHash_set.add(st6); 

        int size = LinkedHash_set.size();
        System.out.println("Set size : " + size);
                
        System.out.println("After Add: ");
        for(Student s : LinkedHash_set){
        ...
        LinkedHash_set.clear(); //remove all elements 
