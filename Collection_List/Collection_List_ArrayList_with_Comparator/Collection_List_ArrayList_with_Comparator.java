...
class Collection_List_ArrayList_with_Comparator {
    
   
    public static void main(String args[]){  

      
        List<Student> arr_list = new ArrayList<Student>();

        System.out.println("arr_list.isEmpty(): "+arr_list.isEmpty());
        ...
        arr_list.add(st2);
        arr_list.add(st3);        
        arr_list.addFirst(st4); // insert at start position
        arr_list.addLast(st5); //insert at end position
        arr_list.add(3, st6); // insert at index position
        ...
        Collections.sort(arr_list, new SortbyID());
        System.out.println("\nSorted by ID:");
        for(Student s : arr_list){
            System.out.println("id: "+ s.id + ", name: "+ s.name +", degree: " + s.Degree.course);
        }

        Collections.sort(arr_list, new SortbyName());
        System.out.println("\nSorted by Name:");
        for(Student s : arr_list){
            System.out.println("id: "+ s.id + ", name: "+ s.name +", degree: " + s.Degree.course);
        }
        ...
        arr_list.clear(); //remove all elements 
